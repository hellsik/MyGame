...
namespace MyGame.Controllers
{
    public class MonsterController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Strength,Intelligence,Dexterity")] Monster monster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Strength,Intelligence,Dexterity")] Monster monster)
        {
            if (ModelState.IsValid)
            {
